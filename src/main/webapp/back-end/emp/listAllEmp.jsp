...
<%
    ...
    List<CustomerVO> list = dao.getAll();       // 此行的list變數(物件)將提供page1.file的第11行取得查詢到的總筆數，再由page1.file進行分頁的需要
...
<html>
<head>
<title>所有客戶資料 - listAllCustomer.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>所有客戶資料 - listAllCustomer.jsp</h3>
<!-- 		剛剛寫到這 . -->
